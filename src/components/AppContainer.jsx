...
import Pharmacists from './login.component/login.component';//'./pharmacists.component/pharmcists.component';//'./reports.component/reports.component';//'./pharmacists.component/AddPharmacist';
